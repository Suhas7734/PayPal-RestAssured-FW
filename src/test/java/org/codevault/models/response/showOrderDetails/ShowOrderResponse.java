...
public class ShowOrderResponse {
    ...
    public ShowOrderResponse(String id, String intent, String status, PaymentSource paymentSource, List<PurchaseUnit> purchaseUnits, String createTime, List<Link> links) {
        super();
        this.id = id;
        this.intent = intent;
        this.status = status;
